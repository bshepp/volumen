...
# Run this after uploading code to S3: .\aws\upload-code-to-s3.ps1
# Does NOT affect the existing V2 instance.

# Encode user-data as base64 (required for run-instances)
$userData = [Convert]::ToBase64String([System.IO.File]::ReadAllBytes("$PSScriptRoot\user-data-v3.sh"))
